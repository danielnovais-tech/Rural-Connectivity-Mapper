...
def test_submit_valid_data(client, sample_submission):
    ...
    response = client.post("/api/submit", data=json.dumps(sample_submission), content_type="application/json")
...
def test_submit_missing_fields(client):
    ...
    response = client.post("/api/submit", data=json.dumps(incomplete_data), content_type="application/json")
...
def test_submit_invalid_coordinates(client, sample_submission):
    ...
    response = client.post("/api/submit", data=json.dumps(invalid_data), content_type="application/json")
...
def test_multiple_submissions(client, sample_submission):
    ...
    # Submit first point
    response1 = client.post("/api/submit", data=json.dumps(sample_submission), content_type="application/json")
    ...
    response2 = client.post("/api/submit", data=json.dumps(submission2), content_type="application/json")
...
def test_submit_with_optional_fields_omitted(client):
    ...
    response = client.post("/api/submit", data=json.dumps(minimal_data), content_type="application/json")

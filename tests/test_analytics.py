...
class TestComputeAnalyticsSummary:
    ...
    def test_compute_analytics_summary_time_to_recommendation(self, mock_analytics_path):
        ...
        track_event("recommendation_requested", session_id, metrics={"duration_ms": 100})
        track_event("recommendation_requested", session_id, metrics={"duration_ms": 200})
        track_event("recommendation_requested", session_id, metrics={"duration_ms": 300})

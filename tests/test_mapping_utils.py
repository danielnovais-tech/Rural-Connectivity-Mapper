    ...
    return [
        {
            ...
            "quality_score": {"overall_score": 85.5, "rating": "Excellent"},
        },
        {
            "id": "test-2",
            "latitude": -22.9068,
            ...
            "quality_score": {"overall_score": 72.0, "rating": "Good"},
        },
    ]
...
def test_generate_map_with_starlink_coverage(sample_data, tmp_path):
    ...
    assert (
        "LayerControl" in content or "leaflet-control-layers" in content.lower() or "layer-control" in content.lower()
    )

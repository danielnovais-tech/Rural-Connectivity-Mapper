...
def test_soc_initialization():
    ...
    config = {"num_cores": 4, "memory_size": 1024, "accelerator": True}
...
def test_radiation_model_initialization():
    ...
    config = {"particle_flux": 5.0, "upset_rate": 1e-4}
...
def test_ai_application_initialization():
    ...
    config = {"task": "image_classification", "input_data": np.random.rand(10, 10)}
...
def test_monitor_state():
    ...
    assert metrics["faults_injected"] == 50

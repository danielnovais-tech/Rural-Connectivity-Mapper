...
def test_get_translation_with_formatting():
    ...
    result = get_translation("insight_best_provider", "en", provider="Starlink", score="95.0")
    assert "Starlink" in result
    assert "95.0" in result

    result_pt = get_translation("insight_best_provider", "pt", provider="Starlink", score="95.0")

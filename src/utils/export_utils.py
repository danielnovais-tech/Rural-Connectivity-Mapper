...
def export_for_hybrid_simulator(data: list[dict], output_path: str = "exports/hybrid_simulator_input.json") -> str:
...
def export_for_agrix_boost(data: list[dict], output_path: str = "exports/agrix_boost_connectivity.json") -> str:
...
def export_ecosystem_bundle(data: list[dict], output_dir: str = "exports/ecosystem") -> dict[str, str]:

...
def get_coverage_data(latitude: float, longitude: float) -> dict | None:
    ...
    try:
        ...
        response = requests.get(STARLINK_COVERAGE_API, params=params, timeout=REQUEST_TIMEOUT)
...
def get_performance_metrics(latitude: float, longitude: float) -> dict | None:
    ...
    try:
        ...
        response = requests.get(STARLINK_PERFORMANCE_API, params=params, timeout=REQUEST_TIMEOUT)
...
def get_availability_status(latitude: float, longitude: float) -> dict | None:
    ...
    try:
        ...
        response = requests.get(STARLINK_AVAILABILITY_API, params=params, timeout=REQUEST_TIMEOUT)

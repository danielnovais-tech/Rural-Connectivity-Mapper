...
BACKHAUL_SCHEMA = {
    "required_fields": ["id", "municipio", "uf", "operadora", "latitude", "longitude", "frequencia", "capacidade_mbps"],
    "optional_fields": ["tecnologia", "data_instalacao", "status"],
    "field_types": {
        "id": "string",
        "municipio": "string",
        "uf": "string",
...
ESTACOES_SCHEMA = {
    "required_fields": ["id", "municipio", "uf", "operadora", "tecnologia", "latitude", "longitude"],
    "optional_fields": ["data_ativacao", "status", "tipo_estacao"],
    "field_types": {
        "id": "string",
        "municipio": "string",
        "uf": "string",
...
ACESSO_FIXO_SCHEMA = {
    "required_fields": ["municipio", "uf", "quantidade", "velocidade", "tecnologia"],
    "optional_fields": ["operadora", "ano", "mes"],
    "field_types": {
        "municipio": "string",
        "uf": "string",
        "quantidade": "int",
...
SCHEMAS = {"backhaul": BACKHAUL_SCHEMA, "estacoes": ESTACOES_SCHEMA, "acesso_fixo": ACESSO_FIXO_SCHEMA}
